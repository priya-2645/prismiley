    ...
    <Layout>
      <Header className="header">
        <div className="pic">
          ...
          <menu className="menubar" style={{width:"-57px"}}>
            <img src={"https://miro.medium.com/max/1838/1*1XbHF9jkQJwiiCdilJZOFw.png"} className="menu" height="36px" alt="menu"/>
            <span>shopby</span>
          </menu>
          <input type="text" id="edc-search" class="form-control edc-search-desk" placeholder="What would you like to buy today?" autocomplete="off" className="search"/>
          <img className="minicart" src={minicart} alt={minicart} height="43px"></img><p style={{position:"relative",left:"106px",top:"-2px"}}>0</p>
